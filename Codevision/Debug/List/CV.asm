...
_0x1B:
	LDS  R30,_key_value
	LDS  R31,_key_value+1
	LDS  R22,_key_value+2
	LDS  R23,_key_value+3
	ADIW R28,6
	RET
; 0000 004D     }
; 0000 004E }
...
; 0000 006D     key_pressed = keypad();
	RCALL _keypad
	STS  _key_pressed,R30
	STS  _key_pressed+1,R31
	STS  _key_pressed+2,R22
	STS  _key_pressed+3,R23
; 0000 006E     display(key_pressed);
	LDS  R26,_key_pressed
	LDS  R27,_key_pressed+1
	RCALL _display
; 0000 006F }
	RJMP _0x1C
; 0000 0070 }
